...
The combination of properties `ID_SERIAL_SHORT` and `ID_USB_INTERFACE_NUM` allows to uniquely identify each serial channel.
The first property is the serial number I set at the beginning of this chapter. Writing a unique serial to each LaunchPad is crucial for a smooth development flow.
