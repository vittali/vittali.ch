...
I then copied these projects to
 ...
 gateway
 gateway-base in the companion repo
...
|ti/drivers/i2s/I2SCC32XXDMA.h | I2CC32XX.h |
...
Unfortunately, I still get plenty of linking errors and I am still not able to build the project.
