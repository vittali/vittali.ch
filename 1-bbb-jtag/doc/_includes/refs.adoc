...
- [[[r25]]] http://software-dl.ti.com/public/hpmp/sitara/debug_pru_using_ccs/presentation_html5.html[Debug PRU with CCS]. Start here to learn to use CCS with the PRU.
