= Getting started with the Beagle Bone Black and the PRU via JTAG
...
I want to program the Programmable Real-Time Unit (PRU) <<r22>> available on the Texas Instruments {r2} via a JTAG debug connection.
